...
/////////////////////////////////////////////////////// ФУНКЦИИ/////////////////////////////////////////////////////////////////////////
func quickSort(preSortedArr []int,left,right int) {
if left>=right{
	return
}
pivotIndx := preSorted(preSortedArr, left, right)
quickSort(preSortedArr, left,pivotIndx-1)
quickSort(preSortedArr, pivotIndx, right)
    }


func preSorted(arr []int,left,right int) int{
	if left >= right {
        return left
    }
